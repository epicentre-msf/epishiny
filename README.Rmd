...
You can launch a demo dashboard with examples of every epishiny module with the `launch_demo_dashboard()` function.
...
fs::file_copy(img_path, "inst/examples/docs/img/dashboard.png", overwrite = TRUE)

app$stop()
```

```{r echo=FALSE}
knitr::include_graphics("inst/examples/docs/img/dashboard.png")
```
