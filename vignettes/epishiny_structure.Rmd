...
controls and options, and output displays. The server function defines the behaviour
of the module and how this changes depending on the inputs that the user specifies.
