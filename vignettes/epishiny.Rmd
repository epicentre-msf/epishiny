...
Now let's set up the geo data in the format required for epishiny. We use the `geo_layer` function to deine a layer, and
...
so that you can build fully-featured without worrying about what is happening on the shiny back-end. But if you do want to 
