...
Then we define a global function `estimate_func()` in `global.R` that estimates R using `{EpiEstim}`. This function also groups by date of notification across locations for the weekly R estimation, then re-aggregates to match the original object (this is currently hard coded for data that is displayed weekly).
...
## Miscellaenous notes about broader potential improvements
