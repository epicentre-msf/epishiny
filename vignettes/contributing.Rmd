...
The package currently uses the [highcharter] package for interactive graphics, [leaflet] for interactive maps and [reactable] and 
[gtsummary] packages for tables. It is recommended to use one of these packages for your outputs if possible to maintain style and functionality
